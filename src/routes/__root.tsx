...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LeetCode Club at Purdue" },
      { name: "description", content: "Purdue's community of programmers mastering LeetCode together." },
      { name: "author", content: "LeetCode Club at Purdue" },
      { property: "og:title", content: "LeetCode Club at Purdue" },
      { property: "og:description", content: "Purdue's community of programmers mastering LeetCode together." },
